...
const TRACK_SIZE = vw(4)
const THUMB_SIZE = vw(20)
...
export default class Slider extends PureComponent {
  ...
  render() {
    ...
    const thumbRight = value.interpolate({
      inputRange: [10, 20],
      outputRange: [10, -20],
      extrapolate: 'clamp'
    })
      ...
      <TouchableWithoutFeedback
        ...
        <View>
          ...
          <View
            ...
            <Animated.View
              renderToHardwareTextureAndroid
              style={[mainStyles.track, trackStyle, { height: vh(60) }]}>
              <Image
                source={localImages.zoomSlider}
                style={{
                  width: '100%',
                  resizeMode: 'contain',
                  zIndex: -1,
            ...
            <Animated.View
              ...
              renderToHardwareTextureAndroid
              style={[
                { backgroundColor: thumbTintColor, top: vh(-8) },
                mainStyles.thumb,
                thumbStyle,
                {
                  transform: [
                    { translateX: thumbLeft },
                    { translateY: thumbRight }
                  ],
                  ...valueVisibleStyle
                }
              ]}>
