...
import { DesignHeight, vh, vw } from '@ecom/utils/dimension'
        ...
        {(wrapperInset: any) => (
          <View
            ...
            {/* {message?.type === 'success' && (
              <View>
                <Icon name="checkbox-marked-circle" size={20} />
              </View>
            )} */}
            <View style={{ display: 'flex', flexDirection: 'row', flex: 1 }}>
                ...
                <Text
                  ...
                  {message?.type === 'error' && (
                    <Text
                      ...
                      onPress={() =>
                        navigationRef.navigate(screenNames.CONTACTUS_MODAL)
                      }
              ...
              {(message?.type !== 'error' || message?.type !== 'invalid') && (
                <View
                  style={
                    ['success', 'danger', 'error', 'invalid']?.includes(
                      message?.type
                    ) && {
                      ...{
                        // position: 'absolute',
